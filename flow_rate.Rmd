...
population <- declare_population(
  stream_meters = add_level(N = 165000, # total number of meters
                            accessible = c(rep(0,95000), rep(1, 70000)), # 0 is location isn't easily accessible from road (roughly a third); 1 is easily accessible (other two thirds)
